...
<div class="visible-md visible-lg">
   <div class="shopping-cart-table">
       <div class="row">
           <div class="col-md-12">
               <h1 class="lbl-shopping-cart lbl-shopping-cart-gio-hang">Giỏ hàngffffffffff <span>(<span
                           class="count_item_pr">44</span> sản phẩm)</span></h1>
           </div>
       </div>
       <div class="row">
           <div class="col-main cart_desktop_page cart-page">
               <form id="shopping-cart" novalidate=""
                             ...
                             @endphp
                                <div class="row shopping-cart-item productid-27698914">
                                   ...
                                   <div class="col-right col-xs-9">
                                      ...
                                      <div class="box-price">
                                            <p class="price pricechange">{{number_format($discountPrice,0,'','.')}}₫</p>
                                      </div>
                               ...
                               <div class="each-row">
                                   ...
                                   <div class="box-style fee">
                                       <div class="total2 clearfix">
                                           ...
                                           <div class="amount">
                                               <p><strong class="totals_price">{{number_format($totalPrice,0,'','.')}}₫</strong>
                                               </p>
                                           </div>
                                       </div>
                                   </div>
                                   <button
                                       ...
                                       onclick="window.location.href='{{route('home')}}'">Tiếp tục
                                       mua hàng</button>
                               </div>
                           </div>
                       </div>
           ...
           <div class="header-cart-content">
                       ...
                       <div class="item-product item ">
                           ...
                           <div class="title-product-cart-mobile">
                               <h3><a href="{{route('detailProduct',['cate'=>$item['cate_slug'],'slug'=>$item['slug']])}}"
                                       title="{{languageName($item['name'])}}">{{languageName($item['name'])}}</a></h3>
                               <p>Giá: <span class="pricechange">{{number_format($discountPrice,0,'','.')}}₫</span></p>
                           </div>
               ...
               <div class="header-cart-price" style="">
                   ...
                   <div class="checkout"><button class="btn-proceed-checkout-mobile"
                           title="Thanh toán ngay" type="button"
                           onclick="window.location.href='{{route('checkout')}}'"><span>Thanh toán
                               ngay</span></button></div>
                   <button class="btn btn-proceed-continues-mobile" title="Tiếp tục mua hàng"
                       type="button" onclick="window.location.href='{{route('home')}}'">Tiếp tục
                       mua hàng</button>
               </div>
           </div>
       </form>
